...
<head>
    ...
    <title>Customer Login - Laundry Management System</title>
            ...
            <div class="col-md-7 col-lg-5">
                <div class="login-card card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form method="POST" action="customer-login-process.php" novalidate>
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <div class="forgot-password">
                                    <a href="../auth/forgot-password.php?source=customer">Forgot Password?</a>
                                </div>
                            </div>
                    ...
                    <div class="login-footer p-3 text-center">
                        <p class="mb-2">Don't have an account? <span class="forgot-password"><a href="../auth/customer-register.php">Register here</a></span></p>

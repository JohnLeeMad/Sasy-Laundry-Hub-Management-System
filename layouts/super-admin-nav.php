        ...
        <header class="bg-white shadow-sm">
            <div class="container-fluid py-3 px-4">
                <div class="d-flex justify-content-between align-items-center">
                    <h1 class="h3 mb-0" style="color: #322266;"><?php echo htmlspecialchars($header); ?></h1>
...
<nav class="sidebar" id="adminSidebar">
    ...
    <div class="sidebar-user">
        <div class="d-flex align-items-center">
            <div class="avatar rounded-circle d-flex align-items-center justify-content-center"
                ...
                <span class="fw-bold text-white"><?php echo substr($_SESSION['super_admin_details']['name'] ?? 'A', 0, 1); ?></span>
            </div>
            <div class="ms-3 d-none d-lg-block">
                <div class="fw-bold"><?php echo htmlspecialchars($_SESSION['super_admin_details']['name'] ?? 'Admin'); ?></div>
                <small><?php echo htmlspecialchars($_SESSION['super_admin_details']['email'] ?? 'admin@example.com'); ?></small>
            </div>
        </div>
    </div>
    ...
    <ul class="sidebar-nav list-unstyled">
        <li class="sidebar-item">
            <a href="../super-admin/dashboard.php" class="sidebar-link d-flex align-items-center">
                <i class="fas fa-tachometer-alt me-3"></i>
                <span class="d-none d-lg-inline">View Dashboard</span>
            </a>
        </li>
        <li class="sidebar-item">
            <a href="../super-admin/customers.php" class="sidebar-link d-flex align-items-center">
                <i class="fas fa-user-friends me-3"></i>
                <span class="d-none d-lg-inline">Customer Accounts</span>
            </a>
        </li>
        <li class="sidebar-item">
            <a href="../super-admin/employees.php" class="sidebar-link d-flex align-items-center">
    ...
    <div class="sidebar-footer">
        <form action="../auth/admin-logout.php" method="POST">

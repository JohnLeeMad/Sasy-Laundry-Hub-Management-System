...
// Status badge function (removed since status column is gone)
...
<script>
    // Search functionality for prelist orders table
    ...
    // Sorting functionality for prelist orders table
    document.querySelectorAll('#prelistOrdersTable .sortable').forEach(header => {
        header.addEventListener('click', () => {
            ...
            rows.sort((a, b) => {
                ...
                // Special handling for Receipt Number (index 1)
                if (colIndex === 1) {
                    // Assuming receipt_number is numeric or alphanumeric
                    return dir * aText.localeCompare(bText, undefined, {
                        numeric: true,
                        sensitivity: 'base'
                    });
                ...
                // Default string comparison for Customer Name (index 2)
                return dir * aText.localeCompare(bText, undefined, {
                    numeric: true,
                    sensitivity: 'base'
                });

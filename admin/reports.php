        ...
        <div class="card-body">
            ...
            <div class="mb-4">
                ...
                <div class="table-responsive">
                    <table class="table">
                        <tr>
                            <td>Total Laundry Revenue (Gross)</td>
                            <td class="text-end">₱<?= number_format($totalProfit, 2) ?></td>
                        </tr>
                        <tr>
                            <td>Less: VAT (12%)</td>
                            <td class="text-end text-danger">-₱<?= number_format($vatOnRevenue, 2) ?></td>
                        </tr>
                        <tr class="fw-bold" style="background-color: #f8f9fa;">
                            <td>Net Revenue (After VAT)</td>
                            <td class="text-end">₱<?= number_format($revenueBeforeVAT, 2) ?></td>
                        </tr>
                    </table>
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr class="fw-bold" style="background-color: #e8f4f8;">
                            <td>Net Profit Before VAT</td>
                            <td class="text-end">₱<?= number_format($netProfitBeforeVAT, 2) ?></td>
                        </tr>
                        <tr>
                            <td>Less: VAT Payable (12%)</td>
                            <td class="text-end text-danger">-₱<?= number_format($vatOnRevenue, 2) ?></td>
                        </tr>
                        <tr class="fw-bold" style="background-color: #d4edda; font-size: 1.1em;">
                            <td>Net Profit After VAT</td>
                            <td class="text-end <?= $netProfitAfterVAT >= 0 ? 'text-success' : 'text-danger' ?>">
                                ₱<?= number_format($netProfitAfterVAT, 2) ?>
                            </td>
                        </tr>
                    </table>
                </div>

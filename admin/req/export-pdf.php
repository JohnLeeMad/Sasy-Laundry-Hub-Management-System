...
$vatOnRevenue = $totalProfit * VAT_RATE;
$revenueBeforeVAT = $totalProfit - $vatOnRevenue;
...
// Calculate net profit before and after VAT
$netProfitBeforeVAT = $totalProfit - $totalExpenses;
$netProfitAfterVAT = $netProfitBeforeVAT - $vatOnRevenue;
...
$html .= '<table border="0" cellpadding="5" cellspacing="0">
    <tr style="background-color: ' . $lightGray . ';">
        <td width="70%"><strong style="color: ' . $primaryColor . ';">Total Laundry Revenue (Gross)</strong></td>
        <td width="30%" align="right"><strong style="color: ' . $accentColor . ';">₱' . number_format($totalProfit, 2) . '</strong></td>
    </tr>
    <tr>
        <td width="70%">Less: VAT (12%)</td>
        <td width="30%" align="right" style="color: #FF0000;">-₱' . number_format($vatOnRevenue, 2) . '</td>
    </tr>
    <tr style="background-color: ' . $lightGray . ';">
        <td width="70%"><strong style="color: ' . $primaryColor . ';">Net Revenue (After VAT)</strong></td>
        <td width="30%" align="right"><strong style="color: ' . $accentColor . ';">₱' . number_format($revenueBeforeVAT, 2) . '</strong></td>
    </tr>
</table><br><br>';
...
// Summary Section
$netColor = ($netProfitAfterVAT >= 0) ? $primaryColor : '#FF0000'; // Red for loss
$html .= '<h2 style="color: ' . $primaryColor . '; border-bottom: 2px solid ' . $accentColor . '; padding-bottom: 5px;">Summary</h2>';
$html .= '<table border="0" cellpadding="5" cellspacing="0">
    <tr>
        <td width="70%">Gross Revenue</td>
        <td width="30%" align="right">₱' . number_format($totalProfit, 2) . '</td>
    </tr>
    <tr>
        <td width="70%">Total Expenses</td>
        <td width="30%" align="right">₱' . number_format($totalExpenses, 2) . '</td>
    </tr>
    <tr style="background-color: #e8f4f8;">
        <td width="70%"><strong style="color: ' . $primaryColor . ';">Net Profit Before VAT</strong></td>
        <td width="30%" align="right"><strong>₱' . number_format($netProfitBeforeVAT, 2) . '</strong></td>
    </tr>
    <tr>
        <td width="70%">Less: VAT Payable (12%)</td>
        <td width="30%" align="right" style="color: #FF0000;">-₱' . number_format($vatOnRevenue, 2) . '</td>
    </tr>
    <tr style="background-color: #d4edda;">
        <td width="70%"><strong style="color: ' . $primaryColor . '; font-size: 12px;">Net Profit After VAT</strong></td>
        <td width="30%" align="right"><strong style="color: ' . $netColor . '; font-size: 12px;">₱' . number_format($netProfitAfterVAT, 2) . '</strong></td>
    </tr>
</table><br>';

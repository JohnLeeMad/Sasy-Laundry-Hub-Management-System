...
// Fetch supply products with category information
...
function generateSupplyTableRows($supplyProducts)
{
    ...
    foreach ($supplyProducts as $product) {
        ...
        echo '</button>';
        // Only show delete button if not a plastic bag product
...
// Find the plastic bag category ID
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form method="POST" action="req/store-product.php" id="productForm">
                        <input type="hidden" name="id" id="productId"> <!-- Hidden field for product ID -->
...
<script>
    // Get the plastic bag category ID from PHP
    ...
    function checkPlasticBagCategory() {
        ...
        // If we're editing an existing product, allow it regardless of category
        if (productId) {
        ...
        // Check if selected category is plastic bag category
        const isPlasticBagCategory = plasticBagCategoryId && categorySelect.value == plasticBagCategoryId;

        // Check if product name contains "plastic bag"
    ...
    function checkPlasticBagProduct() {
        checkPlasticBagCategory(); // Reuse the same logic
    }
    ...
    function populateForm(id, categoryId, name, measurement, price, maxUnit, description) {
        ...
        // Enable the form even for plastic bag products when editing

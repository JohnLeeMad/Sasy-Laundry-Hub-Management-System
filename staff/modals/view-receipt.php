...
// Fetch prices from database (unchanged)
...
// Fetch products with inventory (unchanged)
...
<!-- Smaller Professional Receipt Modal -->
                    ...
                    <div class="card-body p-2">
                        ...
                        <div class="receipt-order-details mb-3">
                            ...
                            <div id="view_receipt_order_details" class="receipt-details-content" style="font-size: 0.85rem; padding: 0.5rem;">
                                <!-- Details will be rendered here with proper line breaks -->
                            </div>
                        </div>
...
<script>
    $(document).ready(function() {
        // Handle viewReceiptModal with improved column layout
        $('#viewReceiptModal').on('show.bs.modal', function(event) {
            ...
            // Get is_whites_order value - check multiple possible formats
            var isWhitesOrder = button.data('is-whites-order');
            
            // Convert to boolean - handle string "1", number 1, boolean true
            ...
            if (isWhitesOrder) {
                ...
                // Remove "Separate Whites:" line from order details if present
            ...
            // Add Accommodated by information

...
// Get filter period from request or default to 'week'
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="mb-1" style="color: var(--primary-color);">Welcome back, Staff <?php echo htmlspecialchars($_SESSION['staff_details']['name'] ?? 'Staff'); ?>!</h2>
...
<script>
    ...
    // Calculate max value for Y-axis with proper rounding
...
function getWeeklyProfitData($conn)
{
    ...
    // Build complete dataset for all 7 days
    foreach ($days as $day) {
        $completeLabels[] = $day;
